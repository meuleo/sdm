    ...
    <div class="col-12">
        <div class="fixed-to">
            ...
            <div class="py-3 ">
                ...
                <a href="index.php" ><button class="btn btn-sm btn-dark" style="background-color: rgb(194, 77, 77);">
                    Folha Completa
                </button></a>
        ...
        <div class="d-flex mb-2 pt-4 px-2">
          ...
          <div class="col-9 row">
            <div class="col-9">
              ...
              <div class="col-2">
                  <input type="submit" name="abrir" value="Abrir" class="btn btn-success">
                </form>
              </div>
        ...
        <div>
          ...
          <div>
            <div class="linha col-11 mx-auto mb-3 py-1 border border-dark border-2 conteudo">
        ...
        <table class="mx-auto"  style="border: 2px solid #000; font-size: 0.8em; width: 95%;">
...
<!-- Primeira linha -->
          ...
          <div class="col-11 my-3 border border-dark border-2 ps-3 mx-auto">
            <ul class="pb-0 m-0">
    ...
    <div class="py-3 ps-3">
      <a href="lista-completa-impressao.php">
        <button class="btn btn-sm btn-success">Guardar Pagina</button>
      </a>
    </div>
